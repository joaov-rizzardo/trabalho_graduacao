...
export interface GoalSelectorRef {
  updateGoal: (goal: GetGoalType) => void;
}
...
const GoalSelector = forwardRef<GoalSelectorRef, GoalSelectorProps>(
  ({ selectedGoal, setGoal }: GoalSelectorProps, ref) => {
    ...
    const updateGoal = (updatedGoal: GetGoalType) => {
                ...
                >
                  ...
                  <View style={styles.itemTextContainer}>
                    ...
                    <View style={{ flexDirection: "row", gap: 20 }}>
                      <Text style={{ ...styles.itemText, ...styles.goalValue }}>
                      ...
                      <Text
                        style={{ ...styles.itemText, ...styles.currentValue }}
                      >
                  ...
                  <View style={styles.circle}>
                    {selectedGoal === goal && <View style={styles.selected} />}
                  </View>
                </TouchableOpacity>
              );
            })}
