...
async function findLastActivities() {
    try {
        const { data: lastActivities } = await backendApi.get<GetLastActivities[]>('/transaction/lastActivities')
        ...
        <ScreenTemplate>
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.container}>
                ...
                <DataBox style={{ flexDirection: 'row' }}>
                    <HomepageCard title="Pontuação" value={level.points} image={require('../../assets/images/velocimetro.png')} />
                    <HomepageCard title="Total economizado" value={finances.totalSavings?.toLocaleString('pt-BR', {
                        style: 'currency',
                        currency: 'BRL',
                    })} image={require('../../assets/images/crescimento.png')} />
                </DataBox>
                <DataBox style={{ flexDirection: 'row' }}>
                    <HomepageCard title="Economias" value={finances.currentSavings?.toLocaleString('pt-BR', {
                        style: 'currency',
                        currency: 'BRL',
                    })} image={require('../../assets/images/cofrinho.png')} />
                    <HomepageCard title="Saldo" value={finances.balance?.toLocaleString('pt-BR', {
                        style: 'currency',
                        currency: 'BRL',
